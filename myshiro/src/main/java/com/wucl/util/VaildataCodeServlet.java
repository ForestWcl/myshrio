...
/**
 * 随机验证码生成工具类， web.xml中配置VaildataCodeServlet servlet即可使用
 * @author copy
 *	
 */
@SuppressWarnings("serial")
public class VaildataCodeServlet extends HttpServlet{
	...
	public static boolean validate(HttpServletRequest request, String validateCode){
		String code;
		code = (String)request.getSession().getAttribute(VALIDATE_CODE);
